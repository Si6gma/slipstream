...
final class GroundEffectMath {
     ...
     */
    static double liftForce(double ySpeed, double hSpeed, double maxSpeed,
    ...
    /** Horizontal acceleration delta to add this tick. Returns 0 if hSpeed is already at or above maxSpeed. */
    static double boostDelta(double hSpeed, double proximity, double acceleration, double maxSpeed) {
