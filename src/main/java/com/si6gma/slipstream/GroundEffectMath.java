...
public final class GroundEffectMath {
   ...
   * Scales with v² like real aerodynamic lift: faster = stronger hold. liftStrength is the fraction
   * of the ySpeed error corrected per tick [0, 1].
   */
  public static double liftForce(
      double ySpeed, double hSpeed, double maxSpeed, double proximity, double liftStrength) {
    ...
    // Restoring force toward ySpeed=0, capped so it never overshoots to the other
    // side
